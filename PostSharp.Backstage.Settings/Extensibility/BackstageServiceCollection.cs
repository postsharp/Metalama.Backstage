...
namespace PostSharp.Backstage.Extensibility
{
    public class BackstageServiceCollection
    {
        ...
        public BackstageServiceCollection AddSingleton<TService>(
            Func<BackstageServiceCollection, TService> serviceFactory)
            => AddSingleton<TService>(serviceFactory(this));


        public IServiceProvider ToServiceProvider() => new ServiceProvider(this);
